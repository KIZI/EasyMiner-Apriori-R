...
class InputSpec extends FlatSpec with Matchers with TemplateOpt {
  ...
  lazy val task1 = new PMMLTask(inputpmml2.get) with AttributeValueNormalizerImpl
  lazy val task2 = new PMMLTask(inputpmml3.get) with AttributeValueNormalizerImpl

  "PMML Task 1" should "filter all quotes" in {
